    ...
    <div className="bg-[url('/images/ssspot.svg')] bg-cover bg-center min-h-screen">
      <div className="grid grid-rows-[auto_1fr_auto] min-h-screen">
        ...
        <div className="mt-4 mx-auto w-full max-w-7xl sm:px-6 lg:px-8 ">
          <div className="mt-4 p-4 md:p-8 rounded-xl shadow-soft border-2 border-lilac/60 grid grid-cols-1 lg:grid-cols-12 gap-4 min-h-[80vh] overflow-auto bg-offwhite/50">
            {/* Sidebar */}
            <div className="md:col-span-2 flex flex-col sm:flex-row md:flex-col gap-4 rounded-xl shadow-soft border-2 border-purple/80 p-4 md:pt-16 items-center text-center">
